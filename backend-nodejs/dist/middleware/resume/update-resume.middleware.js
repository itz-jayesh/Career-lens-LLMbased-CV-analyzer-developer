...
exports.default = Update_Resume_Middleware;
function Update_Resume_Middleware(req, res, next) {
    try {
...
function Update_Resume_Middleware_Template_1(data) {
...
function Update_Resume_Middleware_Template_2(data) {
    if (!data.title || typeof data.title !== "string")
        return "Field 'title' is required and must be a string.";
    // ------------------ Personal Details ------------------
    if (!data.personalDetails)
