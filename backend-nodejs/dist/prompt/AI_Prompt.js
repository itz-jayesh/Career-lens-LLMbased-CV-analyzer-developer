...
class AI_Prompt {
    static Generate_Resume_Get_Suggestion(data, section, prompt) {
...
(Start the optimized Markdown-formatted resume content immediately below this line when enhancing.)`;
    ...
    static Analyze_Resume_Missing_Skills(jobDescription, resumeData) {
...
**💡 ATS Tip:** [One actionable tip to improve the resume's scanability]`;
    ...
    static Analyze_Resume_ATS_Match(jobDescription, resumeData) {
...
* **Action 2:** [One specific formatting or structural tip].`;
    ...
    static Analyze_Resume_Improve_My_Resume(jobDescription, resumeData) {
...
* **Action Verbs:** Replace passive language (e.g., "Responsible for," "Helped with") with strong drivers like **[Suggest 2 verbs based on JD, e.g., 'Spearheaded', 'Optimized']**.`;
    ...
    static Generate_Technical_Questions(jobDescription) {
        return `
...
- Follow the exact schema`;
    ...
    static Generate_Preparation_Plan(jobDescription) {
        return `
