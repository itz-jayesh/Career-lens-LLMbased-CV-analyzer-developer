...
export default function Add_Resume_Middleware(req: Request, res: Response, next: NextFunction) {
    try {
...
function Add_Resume_Middleware_Template_1(data: Partial<any>) {
...
function Add_Resume_Middleware_Template_2(data: Partial<any>) {
