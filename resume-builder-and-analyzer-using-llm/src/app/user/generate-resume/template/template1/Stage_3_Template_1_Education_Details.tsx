...
export default function Stage_3_Template_1_Education_Details() {
    ...
    return (
        <div className="mt-5 md:p-6 rounded-xl shadow-lg text-white">
            <p className="font-semibold text-2xl text-teal-400 mb-4">
                3. Education Details
            </p>

            {resumeData.educationDetails.map((edu, index) => (
                <div key={index} className="relative gap-6 mb-6 bg-[#0f172a] p-2 md:p-4 md:pt-7 rounded-lg border border-slate-700">
                    {index > 0 && (
                        <button
                    ...
                    <div>
                        <p className="font-semibold text-gray-200 mb-1">Title / Degree</p>
                        <input
                            type="text"
                            value={edu.title}
                    ...
                    <div>
                        <p className="font-semibold text-gray-200 mb-1">Institution</p>
                        <input
                            type="text"
                    ...
                    <div>
                        <p className="font-semibold text-gray-200 mb-1">Passing Year / Duration</p>
                        <input
                            type="text"
                            value={edu.year}
