export default function Status_Progress_Template_1({ stage }: { stage: number }) {
    return (
        <div className="flex justify-between items-center px-3 md:px-10">
            ...
            <div className={`hidden md:block md:w-20 xl:w-28 h-1 ${stage >= 2 ? "bg-green-600" : "bg-rose-600"}`}></div>
            ...
            <div className={`hidden md:block md:w-20 xl:w-28 h-1 ${stage >= 3 ? "bg-green-600" : "bg-rose-600"}`}></div>
            ...
            <div className={`hidden md:block md:w-20 xl:w-28 h-1 ${stage >= 4 ? "bg-green-600" : "bg-rose-600"}`}></div>
            ...
            <div className={`hidden md:block md:w-20 xl:w-28 h-1 ${stage >= 5 ? "bg-green-600" : "bg-rose-600"}`}></div>
            ...
            <div className={`hidden md:block md:w-20 xl:w-28 h-1 ${stage >= 6 ? "bg-green-600" : "bg-rose-600"}`}></div>
            ...
            <div className={`hidden md:block md:w-20 xl:w-28 h-1 ${stage >= 7 ? "bg-green-600" : "bg-rose-600"}`}></div>
            <p className={`${7 <= stage ? "bg-green-500" : "bg-rose-500"} flex items-center justify-center rounded-md md:rounded-full text-xl h-10 w-10 md:h-12 md:w-12`}>7</p>
        </div>
    )
}