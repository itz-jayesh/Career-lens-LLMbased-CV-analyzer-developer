...
export default function Stage_5_Template_1_Projects_Details() {
                    ...
                    <div key={index} className="relative bg-[#0f151e] p-2 md:p-6 rounded-xl shadow-md space-y-4 border border-gray-700">
                        {index > 0 && (
                            <button onClick={() => deleteProject(index)}
                                className="md:absolute top-0 right-0 text-red-500 hover:text-red-400 rounded-lg transition bg-black/30 px-2 py-1 flex justify-center items-center gap-2" title="Remove this project">
                                Remove <FaTrash />
                            </button>
                        )}
                        ...
                        <div className="flex gap-4 mt-4">
                            <input
                                ...
                                className="w-2/3 bg-[#0f172a] text-white p-3 rounded-lg border border-gray-600 focus:ring-2 focus:ring-teal-500 outline-none"
                            />
                            <input
                                type="text"
                                ...
                                className="w-2/3 bg-[#0f172a] text-white p-3 rounded-lg border border-gray-600 focus:ring-2 focus:ring-blue-500 outline-none"
                            />
                        </div>
